...
public class Bitacora {
    ...
    public enum Entidad {
        IMPUTADO, MEDIDA_CAUTELAR, ENTREVISTA, SUPERVISION, USUARIO, CONSULTA, REPORTE_DIARIO, CORRESPONDENCIA, CONTROL_OFICIO, SESION, MODULOS_EXTRA
    }

    public enum Accion {
        CREAR, EDITAR, ELIMINAR, CAMBIO_ESTADO, FALLECIMIENTO, CIERRE_CARPETA, FOTO, ASIGNACION, LOGIN, LOGOUT
    }
}
